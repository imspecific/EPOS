...
<html>
   ...
   <body>
      ...
      <form:form method="post" action="/ordernewstock">
		      <div class="header">
		      ...
		      <div class="content">
				<table class="table3">
		            <tr>
		               <h2> Request Stock From Supplier </h2>
		            </tr>
		            <tr>
		               <td> Request Id </td>
		               <td>
		         ...
		         <table class="table1">
		            <tr>
				    	...
				    	<tr>
				    		<td colspan="4"><input type="submit" value="Order"/> &nbsp; <input type="submit" value="Cancel"/></td>
				    	</tr>
		         </table>
		      </div>
      </form:form>
