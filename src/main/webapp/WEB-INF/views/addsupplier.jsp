   ...
   <body>
      <div class="sidenav">
         ...
         <div class="dropdown-container">
            ...
            <a href="/updateoffer"> Update Offer </a>
         </div>
     ...
     <form:form method="post" action="/addsupplier">
      ...
      <div class="content">
         <table class="table1">
				...
				<tr>
					<td>Supplier Id	</td><td> <input type="text" name="sup_Id" placeholder="Auto Generated" disabled></td>
					<td>Name  </td><td> <input type="text" name="sup_Name"></td>
		    	</tr>
				<tr>
			    	<td>Phone No.  </td><td> <input type="text" name="sup_Phone"></td>
			    	<td rowspan="2">Address 	</td><td rowspan="5"> <textarea name="sup_Address" rows="10" cols="2"></textarea></td>
		    	</tr>
		    	<tr>
			    	<td>Email 	</td><td><input type="email" name="sup_Email"></td>
		    	</tr>
		    	<tr>
			    	<td>Country	</td>
			    	<td> 
				    	<select name="country" id="sup_Country">
