...
<html>
	<head>
		<title>Profit n Loss Report</title>
			<style>
		         * {
	...
	<body>
		...
		<form:form method="post" action="/profitlossreport">
			<div class = "content">
				<table class="table1">
					<tr>
						<h3>Profit & Loss Report</h3>
					</tr>
					<tr align="left"> Sales: </tr>
					<tr>
						<td>Sales in INR</td> <td>000</td>
					<tr > </tr>
					 <tr rowspan="3">
						<td>Total in INR:</td> <td>000</td>
					 </tr>
					 <tr rowspan="3">
						<td>Purchase:</td> <td>000</td>
					 </tr>
					 <tr>
						<td>Total in INR: </td> <td>000</td>
					 </tr>
					 <tr>
						<td colspan="2" align="right"><input type="button" value="Print" />	&nbsp;&nbsp;&nbsp;	<input type="button" value="Cancel"/></td>
					 </tr>
				</table>
			</div>
	    </form:form>
