	...
	<body>
		...
		<table class="table1">
			...
			<tr>
				...
				<td><input type="button" value="Generate Report"></td>				
			</tr>		
		</table>
		<br/>
		<table	class="table2" id="purchase">
			  <tr>
				    <th>Product Id</th>
				    <th>Product Name</th>
				    <th>Product Brand</th>
			  ...
			  <tr>
				<td colspan="8" align="right"><input type="button" value="Print" />	&nbsp;&nbsp;&nbsp;	<input type="button" value="Cancel"/></td>
			  </tr> 
