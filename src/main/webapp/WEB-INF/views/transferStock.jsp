      ...
      <div class="content">
		<table class="table3">
            ...
            <tr>
               ...
               <td colspan="6"><input type="submit" value="Search"/> &nbsp; <input type="submit" value="Cancel"/></td>
            </tr>
         </table>
         <br />
         <table class="table2">
         ...
         <table class="table1">
		    ...
		    <tr>
		    	<td colspan="6"><input type="submit" value="Transfer"/> &nbsp; <input type="submit" value="Cancel"/></td>
		    </tr>
         </table>
      </div>
      <script>
